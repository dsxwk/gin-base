...
type MenuAction struct {
	...
	Label       string          `gorm:"column:label;type:varchar(30);not null;comment:功能名称" json:"label"`                                    // 功能名称
	AuthValue   string          `gorm:"column:auth_value;type:varchar(100);not null;comment:权限标识" json:"authValue"`                          // 权限标识
	...
	Children    []MenuAction    `json:"children" gorm:"-"`                                                                                   // 子级功能
